...
<body>
    ...
    <div class="course-container">
        <h1 class="text-center mb-5">日本語タイピングコース</h1>
        ...
        <div class="level-card">
            ...
            <div class="lesson-list">
                ...
                <a href="japanese_lesson.php?level=<?php echo urlencode($level); ?>&lesson=<?php echo $lesson['lesson_number']; ?>&id=<?php echo $lesson['id']; ?>" 
